...
import { FolderOpen, MapPin, CheckSquare, DollarSign, FileText, Flag, BarChart2, Map, RotateCcw, Activity, Crown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6" dir="rtl">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Manager Card */}
        <Link href="/dashboard/projects-control/manager" className="group block mb-8">
          <div className="bg-slate-900 border border-amber-500/30 rounded-2xl p-5 hover:border-amber-500/60 hover:bg-slate-800/70 transition-all duration-200">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h2 className="text-base font-bold text-white">مدير إدارة المشاريع</h2>
