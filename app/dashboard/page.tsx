  ...
  return (
    <div className="pointer-events-auto relative min-h-screen overflow-hidden bg-slate-950/70 px-4 py-6 md:px-6" dir="rtl">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-6 pt-16">
        ...
        <div className="rounded-2xl border border-violet-500/30 bg-gradient-to-r from-violet-950/60 to-slate-950/80 px-5 py-4 flex flex-wrap items-center justify-between gap-4 shadow-xl backdrop-blur-xl">
