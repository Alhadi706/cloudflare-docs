...
import {
  ArrowRight, Crown, Brain, Map, MonitorPlay, Layers, Activity, Globe, BarChart2, Radio,
} from 'lucide-react';
...
const sections = [
  ...
  },
  {
    ...
    icon: Map,
    items: ['رسم وتعديل الخرائط', 'إدارة الطبقات', 'قواعد البيانات المكانية'],
  },
  {
    ...
    icon: MonitorPlay,
    items: ['مراقبة حية', 'لوحات المؤشرات الجغرافية', 'رصد التحركات'],
  },
  {
    ...
    icon: Globe,
    items: ['خريطة المشاريع', 'بيانات الموظفين والأصول', 'أوامر العمل'],
  },
  {
    ...
    icon: Layers,
    items: ['أوامر العمل', 'الفرق الميدانية', 'طبقات الصيانة'],
  },
  {
    ...
    icon: Activity,
    items: ['تحليل التضاريس', 'المخاطر المكانية', 'الأدوات المتقدمة'],
  },
];
...
const monitoringLinks = [
  {
    ...
    hint: 'مراجعة الطبقات والبيانات المكانية واعتمادها',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8" dir="rtl">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div>
          <Link href="/dashboard/gis-sovereignty" className="inline-flex items-center gap-1.5 text-slate-500 hover:text-slate-300 transition-colors text-sm mb-4">
        ...
        {activeTab === 'correspondence' && (
          <InternalMailTab department="gis_manager" title="نظام المراسلات الموحد - إدارة GIS والسيادة الجغرافية" />
        )}
