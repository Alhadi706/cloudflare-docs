...
import { MapPin, Globe, Layers, BarChart2, Satellite } from 'lucide-react';

const links = [
  {
    href: '/dashboard/gis-sovereignty/spatial-analytics',
    icon: BarChart2,
    label: 'التحليلات المكانية',
    desc: 'تحليل البيانات الجغرافية والمناطق',
  ...
  },
  {
    ...
    desc: 'الطبقات الهندسية وإدارة المشاريع الميدانية',
    color: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-blue-500/20',
  },
  {
    href: '/dashboard/admin-gateway/platform-intelligence/spatial-intelligence',
    icon: Globe,
    label: 'الذكاء المكاني (AI)',
    desc: 'تحليل مكاني ذكي ورؤى جغرافية تنبؤية',
  ...
  },
  {
    ...
    desc: 'صور الأقمار الاصطناعية والرصد الميداني',
  ...
  },
  {
    ...
    icon: MapPin,
    label: 'مراجعة GIS',
    desc: 'مراجعة واعتماد البيانات الجغرافية للأصول',
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-100">التحليلات المكانية</h1>
              <p className="text-sm text-slate-500">تحليل المناطق الجغرافية والبيانات الإنشائية</p>
            </div>
          </div>
