...
import {
  ArrowRight, Crown, BookOpen, PieChart, Banknote, UserCheck,
  TrendingUp, ShieldCheck, DollarSign, Activity, BarChart2, Receipt,
} from 'lucide-react';
...
const sections = [
  ...
  },
  {
    ...
    icon: TrendingUp,
    items: ['الموازنات السنوية', 'تحليل الانحرافات', 'التوقعات والسيناريوهات'],
  },
  {
    ...
    icon: ShieldCheck,
    items: ['مراجعة الصرف', 'الاعتمادات والموافقات', 'الرقابة المالية'],
  },
  {
    ...
    icon: DollarSign,
    items: ['التقرير المالي المركزي', 'ملخصات الأداء', 'الاتجاهات'],
  },
];
...
const monitoringLinks = [
  {
    ...
    hint: 'المرجع الرئيسي للتقارير والتحليلات المالية',
  },
  {
    href: '/dashboard/admin-gateway/finance/budgets',
    icon: PieChart,
    label: 'مؤشرات أداء الميزانية',
    hint: 'مقارنة المعتمد مقابل المنفذ والانحرافات',
  },
  {
    href: '/dashboard/admin-gateway/finance/expenses',
    icon: Receipt,
    label: 'مراقبة الرقابة المالية',
    hint: 'التجاوزات والالتزام المالي المؤسسي',
  },
  {
    href: '/dashboard/admin-gateway/platform-intelligence/monitoring',
    icon: Activity,
    label: 'مراقبة المنصة المالية',
    hint: 'لوحة مراقبة مركزية للمؤشرات المالية',
  },
];

export default function FinanceHubManagerPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8" dir="rtl">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div>
          <Link href="/dashboard/finance-hub" className="inline-flex items-center gap-1.5 text-slate-500 hover:text-slate-300 transition-colors text-sm mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-0.5">Finance & Accounting — Department Manager</p>
            </div>
          </div>
        </div>
